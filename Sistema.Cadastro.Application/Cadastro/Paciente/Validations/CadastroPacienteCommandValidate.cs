    ...
    public class CadastroPacienteCommandValidate : AbstractValidator<CadastroPacienteCommand>
    {
        public CadastroPacienteCommandValidate()
        {
            ...
            RuleFor(c => c.PlanoSaude)
               .NotEmpty()
               .When(c => c.PlanoSaude != EPlanoSaude.SemPlano)
            ...
            RuleFor(c => c.Endereco.Cep)
              .NotEmpty()
              .WithMessage("É preciso informar o numero do CEP.")
              .WithName("Cep");

            RuleFor(c => c.Endereco.Numero)
             .NotEmpty()
             .WithMessage("É preciso informar o numero do endereço.")
             .WithName("Numero de Endereco");
        }
